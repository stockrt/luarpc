...
duração de 21 segundos para 10000 requisições. O \textit{string} enviado neste
...
o método \textit{foo}\ref{ifacefoo}, levando apenas 2 segundos para executar
...
tempo subiu para 7 segundos em cada cliente.
...
\subsection{Conexão persistente contra conexão sem reuso}\label{subsec:persist}
\subsection{Serializando e deserializando uma tabela
grande}\label{subsec:serdeser}
\subsection{Diferente número de clientes para pool de
conexões}\label{subsec:diffpool}
...
String pequena (1B) & Persistente & 1120KB & 1060KB & 2s \\
String grande (10KB) & Persistente & 104MB & 1060KB & 21s \\
String pequena (1B) & Close & 1120KB & 1060KB & 4s \\
String grande (10KB) & Close & 104MB & 1060KB & 21s \\
Serialização de tabela & Persistente & 21MB & 1060KB & 8s \\
Serialização/deserialização de tabela & Persistente & 21MB & 1060KB & 9s \\
Serialização de tabela & Close & 21MB & 1060KB & - \\
Serialização/deserialização de tabela & Close & 21MB & 1060KB & - \\
Serialização de tabela & Local & - & - & 4s \\
Deserialização de tabela & Local & - & - & 2s \\
Serialização/deserialização de tabela & Local & - & - & 6s \\
\hline
\end{tabular}}
...
seja, sem bloqueio) a capacidade de atendimento do servidor passou para 5000
